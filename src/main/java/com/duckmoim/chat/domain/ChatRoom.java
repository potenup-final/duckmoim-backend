...
public class ChatRoom extends BaseEntity {
   ...
   * 101명이 된다. 중복 초대가 같은 창에서 겹치면 {@code uq_chat_room_member} 가 두 번째를 거부하는데, 그 실패는 여기서 번역되지 않아 500 으로
   * 나간다.
   *
   ...
   *
   * <p><b>바꿀 때는 증거가 먼저다.</b> 방이 실제로 커지거나 이 경로에서 제약 위반 500 이 로그에 잡히면 그때 다시 정한다.
   */
